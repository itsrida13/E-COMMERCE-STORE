              ...
              <div className="cart-item-details">
                ...
                <p className="price">
                  {item.product.isBundle ? (
                    <span style={{ color: "#db2777", fontWeight: "bold" }}>${item.product.bundlePrice?.toFixed(2)} (Bundle)</span>
                  ) : item.product.isDiscounted && item.product.discountedPrice > 0 ? (
                    <span>
                      <span style={{ color: "#db2777", marginRight: "6px" }}>${item.product.discountedPrice?.toFixed(2)}</span>
                      <span style={{ textDecoration: "line-through", color: "#9ca3af", fontSize: "12px" }}>${item.product.price?.toFixed(2)}</span>
                    </span>
                  ) : (
